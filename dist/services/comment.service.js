...
exports.CommentService = {
    ...
    async createComment(postId, userId, dto) {
        ...
        if (dto.contentText?.trim()) {
            void moderation_service_1.ModerationService.moderateAndUpdate("comment", comment._id.toString(), dto.contentText, {
                reportCount: 0,
    ...
    async createReply(postId, userId, dto) {
        ...
        const reply = await comment_model_1.CommentModel.create({
            ...
            parentCommentId: dto.parentCommentId
                ? new mongoose_1.Types.ObjectId(dto.parentCommentId)
                : undefined,
            originalCommentId: dto.originalCommentId
                ? new mongoose_1.Types.ObjectId(dto.originalCommentId)
                : undefined,
        });
        ...
        if (dto.contentText?.trim()) {
            void moderation_service_1.ModerationService.moderateAndUpdate("comment", reply._id.toString(), dto.contentText, {
                reportCount: 0,
