...
exports.createComment = (0, async_handler_1.asyncHandler)(async (req, res) => {
    ...
    void interaction_tracker_service_1.interactionTrackerService
        .track({
        userId,
        postId,
        type: user_interaction_model_1.InteractionType.COMMENT,
        source: user_interaction_model_1.InteractionSource.PROFILE,
    })
        .catch((err) => console.error("[CommentController] track createComment error:", err));
...
exports.createReply = (0, async_handler_1.asyncHandler)(async (req, res) => {
    ...
    void interaction_tracker_service_1.interactionTrackerService
        ...
        .catch((err) => console.error("[CommentController] track createReply error:", err));
