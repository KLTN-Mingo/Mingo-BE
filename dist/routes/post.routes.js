...
router.post("/:id/save", auth_middleware_1.authMiddleware, post_controller_1.savePost);
router.delete("/:id/save", auth_middleware_1.authMiddleware, post_controller_1.unsavePost);
router.post("/:id/share", auth_middleware_1.authMiddleware, post_controller_1.sharePost);
// ── Comments của post ─────────────────────────────────────────────────────────
