...
// ══════════════════════════════════════════════════════════════════════════════
router.post("/blocks", block_controller_1.blockUser);
router.delete("/blocks/:userId", block_controller_1.unblockUser);
router.get("/blocks", block_controller_1.getBlockedUsers);
// ══════════════════════════════════════════════════════════════════════════════
